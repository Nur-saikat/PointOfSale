...
namespace PointOfSale.Business.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<User> GetByCredentials(string name, string password)
        {

            User user_found = await _repository.Get(u => u.Name.Equals(name) && u.Password.Equals(password));
